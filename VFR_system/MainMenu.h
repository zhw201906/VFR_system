...
#define  PAGE_SUB_NUM        (PAGE_USERINFO_NUM)/(PAGE_USER_NUM_BACE) 
...
public:
    ...
    void AddOneFaceLibInfo();
    void DealAddOneFaceLib(FaceLibInfo &face_info);
...
public:
    ...
    QMap<int, UserInfo>      user_detail_info_map;    //记录当前页每个用户的详细信息  pic_index--->用户信息
	int                   group_cur_id_;
    ...
    FaceLibInfoOperator       *p_operator_lib_ui;
