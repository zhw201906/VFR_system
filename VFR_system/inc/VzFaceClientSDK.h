...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_FaceSetCenterServer(VzClientHandle handle,
  const VZ_CENTER_SERVER_INFO *pParam);
...
*  @
*/
VZ_API int __STDCALL VzLPRClient_FaceGetCenterServer(VzClientHandle handle,
  VZ_CENTER_SERVER_INFO *pParam);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_FaceSetCenterServerDevReg(VzClientHandle handle,
	const VZ_CENTER_SERVER_DEV_REG *pParam);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_FaceGetCenterServerDevReg(VzClientHandle handle,
	VZ_CENTER_SERVER_DEV_REG *pParam);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_FaceSetCenterServerAlarm(VzClientHandle handle, 
	const VZ_CENTER_SERVER_ALARM_PARAM *pParam);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_FaceGetCenterServerAlarm(VzClientHandle handle,
	VZ_CENTER_SERVER_ALARM_PARAM *pParam);
/**
*  @brief 设置人脸抓拍（检测）参数
*  @param [IN] handle 由VzLPRClient_Open函数获得的句柄
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_FaceSetSnapshotParam(VzClientHandle handle,
	const VZ_FACE_SNAPSHOT_PARAM *pParam);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_FaceGetSnapshotParam(VzClientHandle handle, 
  VZ_FACE_SNAPSHOT_PARAM *pParam);
