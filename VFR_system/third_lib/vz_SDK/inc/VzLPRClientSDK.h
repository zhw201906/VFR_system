...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_GetOvzid(VzLPRClientHandle handle, VZ_OVZID_RESULT* pData);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_EnableDevicegroup(VzLPRClientHandle handle, VZ_OVZID_INFO *pData);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_OpenAuth(const char *pStrIP, WORD wPort, const char *pStrUserName, const char *pStrPassword, const char* key);
...
*  @ingroup group_device
*/
VZ_API int __STDCALL VzLPRClient_SetDisconnectPlatesCallBack(VzLPRClientHandle handle, VZLPRC_PLATE_INFO_CALLBACK func, void *pUserData);
...
*  @ingroup group_device
*/
VZ_API int __STDCALL VzLPRClient_LoadDisconnectPlates(VzLPRClientHandle handle);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_XGet_RegistrationStatusParam(VzLPRClientHandle handle, int *status);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_XSet_RegistrationParam(VzLPRClientHandle handle, int request_status);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_XSet_ModelCheckStatus(VzLPRClientHandle handle, int distance, float deltax, float error_ratio);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_XGet_ModelCheckStatus(VzLPRClientHandle handle, int* status);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_GetMjpegURL(const char *pStrIP, WORD wPort, char* sn, WORD mjpeg_port, char* mjpeg_url, int url_len, const char* app_id, const char* app_key);
...
*  @ingroup group_device
*/
VZ_API int __STDCALL VzLPRClient_PDNSGetAppKeyAndID(const char *deviceip, int port, const char *email, const char *password, char* new_appid, int appid_len, char* new_appkey, int appkey_len);
...
*  @ingroup group_device
*/
VZ_API int __STDCALL VzLPRClient_PDNSBindDevice(const char *deviceip, int port, const char *email, const char* appid, const char *appkey, const char *sn);
...
*  @ingroup group_device
*/
VZ_API int __STDCALL VzLPRClient_PDNSGetDevice(const char *deviceip, int port, const char *email, const char* appid, const char *appkey, const char *sn, VZ_LPRC_PDNS_DEVICE_LIST *device_list);
...
*  @ingroup group_device
*/
VZ_API int __STDCALL VzLPRClient_PDNSGetGroup(const char *deviceip, int port, const char *email, const char* appid, const char *appkey, VZ_LPRC_PDNS_GROUP_LIST *group_list);
...
*  @ingroup group_device
*/
VZ_API int __STDCALL VzLPRClient_PDNSGetDeviceByGroupID(const char *deviceip, int port, const char *email, const char* appid, const char *appkey, int group_id, VZ_LPRC_PDNS_DEVICE_LIST *device_list);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_PDNSGetHttpInfo(VzLPRClientHandle handle, char *deviceip, int ip_len, int *port);
...
*  @ingroup group_device
*/
VZ_API int __STDCALL VzLPRClient_PDNSGetRegionDevice(const char *deviceip, int port, const char* appid, const char *appkey, const char *region_name, VZ_LPRC_PDNS_DEVICE_LIST *device_list);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_SetPlateEnterLeaveCallBack(VzLPRClientHandle handle, VZLPRC_PLATE_ENTER_LEAVE_CALLBACK func, void* pUserData);
...
/**
*  @brief 上传语音文件(设备端保存的最大文件数不超过10，超过时会覆盖最高上传的文件，文件大小不超过2M)
*  @param [IN] handle 由VzLPRClient_Open函数获得的句柄
*  @param [IN] file_path 语音文件的路径(如d:\\test.wav)
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_UpdateLoadWaveFile(VzLPRClientHandle handle, const char* file_path);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_GetUpdateLoadWaveState(VzLPRClientHandle handle);
...
/**
*  @brief 设置路侧停车识别结果回调(弃用)
*  @param [IN] handle 由VzLPRClient_Open函数获得的句柄
*  @param [IN] func 回调接口
*  @param [IN] pUserData 用户自定义数据
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzLPRClient_SetRoadSiteResultCallBack(VzLPRClientHandle handle, VZLPRC_ROAD_SITE_RESULT_CALLBACK func, void* pUserData);
...
*/
VZ_API int __STDCALL VzLPRClient_TalkStartByWaveFile(VzLPRClientHandle handle, const char *strFileName);
...
*  @return 返回值：返回值为0表示成功，返回其他值表示失败
*/
VZ_API int __STDCALL VzLPRClient_TalkStop(int iTalkHandle);
...
*  @return 返回值：本地音频发送的句柄，需要保存起来，用于其他本地音频发送相关的操作
*/
VZ_API int __STDCALL VzLPRClient_TalkStart(VzLPRClientHandle handle, VZLPRC_CallBackTalkData fTalkDataCallBack, DWORD dwUser);
...
*/
VZ_API int __STDCALL VzLPRClient_OpenSound(VzLPRClientHandle handle);
...
*  @return 返回值：返回值为0表示成功，返回其他值表示失败
*/
VZ_API int __STDCALL VzLPRClient_CloseSound(int iAudioPlayHandle);
...
*  @return 返回值：音频播放句柄，需要保存起来，用于其他音频输出的操作
*/
VZ_API int __STDCALL VzLPRClient_OpenSoundData(VzLPRClientHandle handle, int bNeedEncode,
...
*  @return 返回值：返回值为0表示成功，返回其他值表示失败
*/
VZ_API int __STDCALL VzLPRClient_CloseSoundData(int iSoundDataHandle);
...
*  @return 返回值：返回值为0表示成功，返回其他值表示失败
*/
VZ_API int __STDCALL VzLPRClient_AudioEnable(VzLPRClientHandle handle, int bEnable);
...
*  @return 返回值：返回值为0表示成功，返回其他值表示失败
*/
VZ_API int __STDCALL VzLPRClient_TalkStop_V2(int iTalkHandle);
...
*  @return 返回值：本地音频发送的句柄，需要保存起来，用于其他本地音频发送相关的操作
*/
VZ_API int __STDCALL VzLPRClient_TalkStart_V2(VzLPRClientHandle handle, VZLPRC_CallBackTalkData_V2 fTalkDataCallBack, void* pUser);
...
*  @return 返回值：音频播放句柄，需要保存起来，用于其他音频输出的操作
*/
VZ_API int __STDCALL VzLPRClient_OpenSoundData_V2(VzLPRClientHandle handle, int bNeedEncode,
...
*  @return 返回值：返回值为0表示成功，返回其他值表示失败
*/
VZ_API int __STDCALL VzLPRClient_CloseSoundData_V2(int iSoundDataHandle);
