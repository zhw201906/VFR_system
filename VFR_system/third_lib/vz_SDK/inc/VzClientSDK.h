...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzClient_SetCenterServerAlarm(VzLPRClientHandle handle, 
	const VZ_CENTER_SERVER_ALARM_PARAM *pAlarmParam);
...
*  @return 返回值为0表示成功，返回其他值表示失败。
*/
VZ_API int __STDCALL VzClient_GetCenterServerAlarm(VzLPRClientHandle handle, 
	VZ_CENTER_SERVER_ALARM_PARAM * pAlarmParam);
...
*  @ingroup group_callback
*/
typedef void (__STDCALL *VZ_VIDEO_DECODE_DATA_CALLBACK)(int play_handle, void *pUserData,
